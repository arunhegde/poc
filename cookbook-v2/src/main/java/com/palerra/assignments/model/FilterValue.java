...
public class FilterValue {
    ...
    public FilterValue withDisplayname(String displayname) {
        this.displayname = displayname;
        return this;
    }
    ...
    public FilterValue withWeight(Integer weight) {
        this.weight = weight;
        return this;
    }
    ...
    public FilterValue withVal(String val) {
        this.val = val;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FilterValue) == false) {
            return false;
        }
        FilterValue rhs = ((FilterValue) other);
